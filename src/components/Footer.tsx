        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 justify-between">
          ...
          <div className="flex flex-col gap-10">
            ...
            <div className="flex gap-5">
              ...
              <a
                href="https://wa.me/919500041579"
                target="_blank"
                rel="noopener noreferrer"
              >
                <img src={Whatsapp} alt="Whatsapp" className="w-15" />
              </a>

              <a href="https://www.facebook.com/profile.php?id=61572882549476">
                <img src={Facebook} alt="Facebook" className="w-15" />
              </a>
              <a href="https://www.linkedin.com/in/kishore-kumar-b8529b284/">
                <img src={Linkdin} alt="LinkedIn" className="w-15" />
              </a>
            </div>
